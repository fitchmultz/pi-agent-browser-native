...
export async function runAgentBrowserProcess(options: {
	...
	return await new Promise<ProcessRunResult>((resolve) => {
		...
		const spawnCommand = buildAgentBrowserSpawnCommand(prepareAgentBrowserSpawnArgs(args, ownedManagedSessionCompatibilityEnv.AGENT_BROWSER_USER_AGENT, preserveAttachedBrowserSession), processPlatform, { path: childEnv.PATH });
