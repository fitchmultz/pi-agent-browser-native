...
function buildAgentBrowserResultDetails(options: FinalResultInput, nextActions: AgentBrowserNextAction[] | undefined): Record<string, unknown> {
	...
	return {
		...
		error: options.plainTextInspection || options.plainTextOutput ? undefined : options.presentationEnvelope?.error,
		...
		parseError: options.plainTextInspection || options.plainTextOutput ? undefined : options.parseError,
		...
		stdout: options.plainTextInspection || options.plainTextOutput ? options.inspectionText ?? "" : undefined,
