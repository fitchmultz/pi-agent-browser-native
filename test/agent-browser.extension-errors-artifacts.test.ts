/**
 * Purpose: Verify extension entrypoint validation-error, diagnostic, artifact, and fallback contracts.
 * Responsibilities: Assert malformed args/envelopes, timeout progress, artifact lifecycle, selector/overlay diagnostics, tab drift, download fallback, and parse-spill handling.
