---
name: agent-browser
description: Native browser automation in this repository goes through the `agent_browser` pi tool, not the legacy bash-backed skill. Use when the task involves opening websites, taking snapshots, clicking, filling forms, scraping, screenshots, UI testing, or other browser automation.
---

# agent-browser

In this repository, browser automation should use the native `agent_browser` tool.
