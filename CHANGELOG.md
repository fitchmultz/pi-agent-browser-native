...
- Preserve valid nested serialized JSON during redaction so auth URLs cannot break JSON escaping or expose adjacent secret fields in tool results and exports.
