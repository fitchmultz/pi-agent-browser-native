...
- **Managed restore persistence:** seed a cookie plus localStorage/sessionStorage, close the first managed browser, create a new extension harness with the same cwd, reopen the fixture, and assert all three values restore before closing the second browser.
