 ...
 */
// Delta vs upstream oh-my-pi: import points at the vendored protocol copy, and
// the relay host is configurable (see chrome-relay/VENDOR.md).
import type { ExtToRelayMessage, RelayToExtMessage, TabSnapshot } from "../protocol";
...
/** Bare hostname/IP only: no scheme, path, userinfo, or whitespace. */
function sanitizeHost(raw: unknown): string {
